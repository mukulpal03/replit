    ...
    visual: (
      ...
      >
        ...
        <div style={{ color: "#5B7FFF" }}>
          ✓ Environment ready <span style={{ color: "#6E6D6A" }}>in 2.4s</span>
        </div>
  ...
  },
  {
    ...
    visual: (
      ...
      >
        ...
        <div style={{ color: "#2DD98F" }}>
          ✓ Build complete <span style={{ color: "#3E3D3B" }}>12.3s</span>
        </div>
        <div style={{ color: "#2DD98F" }}>✓ Health check passed</div>
        <div style={{ color: "#5B7FFF", marginTop: "4px" }}>
          🚀 Live: <span style={{ color: "#F0EEE8" }}>app.railway.app</span>
        </div>
      </div>
    ),
    size: "large", // 2/3
